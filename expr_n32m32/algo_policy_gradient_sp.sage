...
class Agent_AGRP(object):
    ...
    def __init__(self, NAME):
        ...
        self.MODEL_AGRP_VALUE_FIELD_SP = None;
    ...
    def Q_function(self,SOLUTION_PART,SOLUTION_PART_VEC):
        ...
        Q_VALUE = self.MODEL_AGRP_VALUE_FIELD_SP.predict([ np.array([SOLUTION_PART_VEC],dtype=float),np.array([SP01_POINTS[0]],dtype=float),np.array([SP01_POINTS[1]],dtype=float) ])[0];
...
AGENT.MODEL_AGRP_VALUE_FIELD_SP = MODEL_AGRP_VALUE_FIELD_SP;

...
class Agent_AGRP(object):
    ...
    def __init__(self, NAME):
        ...
        self.MODEL_ML_POLY_FITTER = None;
    ...
    def Q_function(self,SOLUTION_PART,SOLUTION_PART_VEC):
        ...
        HIDDEN_STATE = PF_PROCESSOR.fit_transform([ HIDDEN_STATE ]);
        Q_VALUE = self.MODEL_ML_POLY_FITTER.predict(HIDDEN_STATE)[0];
        return Q_VALUE;
...
# ============================== Loading Models ===================================
from model_ml_poly_fitter import *;
...
AGENT.MODEL_ML_POLY_FITTER = MODEL_ML_POLY_FITTER;AGENT.MODEL_AGRP_HIDDEN_STATE_SP = MODEL_AGRP_HIDDEN_STATE_SP;

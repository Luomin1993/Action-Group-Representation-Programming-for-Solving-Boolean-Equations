...
#include <map>
#include <ctime>
// g++ app_ant_colony_algo.cpp -o app -lginac -lcln
...
float infomation_cent(int const& SAT_NUM_NOW)
{
    return 1/exp(MAX_EQ_NUM/SAT_NUM_NOW);
}
...
int main(int argc, char const *argv[])
{
    ...
    while(true)
    {
        ...
        IS_UPDATED = false;
        if (infomation_cent(SAT_NUM_NOW)>0.350)
        {
            cout<<"--- Dense Info_Cent Region ---"<<endl;

...
#include <map>
#include <ctime>
// g++ app_simulated_annealing_reduction.cpp -o app -lginac -lcln
...
int main(int argc, char const *argv[])
{
    ...
    //cout<<ITEMS_VARS_USED.size()<<endl;return 0;
    ...
    GiNaC::exmap SOLUTION_NEXT;int TRAPPED_INTO_WHILE = 0;int RAND_FLAG;
    TIME_START = clock();
    while(true)
    {
